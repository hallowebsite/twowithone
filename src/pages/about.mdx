...
nice images to every saying. We looked for Public Domain images at least loosely connected
...
to get suggestions for better (public domain) works to illustrate the sayings (use [the contact form](/contact))
